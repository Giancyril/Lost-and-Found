...
exports.getCoordinates = exports.CAMPUS_ZOOM = exports.CAMPUS_CENTER = exports.CAMPUS_COORDINATES = void 0;
...
exports.CAMPUS_CENTER = [8.3596, 124.8682];
exports.CAMPUS_ZOOM = 17;
// Fuzzy match — finds best coordinate for a location string
const getCoordinates = (location) => {
    const lower = location.toLowerCase().trim();
    // Exact match
    if (exports.CAMPUS_COORDINATES[lower])
        return exports.CAMPUS_COORDINATES[lower];
    // Partial match — check if any key is contained in the location string
    for (const [key, coords] of Object.entries(exports.CAMPUS_COORDINATES)) {
    ...
    if (roomMatch) {
        ...
        if (num >= 201 && num <= 210)
            return exports.CAMPUS_COORDINATES["swdc"];
        // Business Administration: Rooms 301 - 320
        if (num >= 301 && num <= 320)
            return exports.CAMPUS_COORDINATES["college of business"];
        const roomKey = `room ${num}`;
        if (exports.CAMPUS_COORDINATES[roomKey])
            return exports.CAMPUS_COORDINATES[roomKey];
        // Unknown room — place near building center with small offset
        return [exports.CAMPUS_CENTER[0] + Math.random() * 0.0002, exports.CAMPUS_CENTER[1] + Math.random() * 0.0002];
    }
    return null;
};
