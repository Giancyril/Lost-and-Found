...
const authOptional_1 = __importDefault(require("../midddlewares/authOptional"));
...
router.post('/items/:itemId/comments', commentRateLimit, (0, authOptional_1.default)(), commentsController_1.commentsController.createComment);
