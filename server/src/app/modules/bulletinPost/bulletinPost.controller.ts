...
const createPost = async (req: Request, res: Response) => {
  try {
    ...
    sendResponse(res, { statusCode: StatusCodes.CREATED, success: true, message: "Post created successfully", data: result });
  } catch (error: any) {
...
const getPosts = async (req: Request, res: Response) => {
  try {
    ...
    sendResponse(res, { statusCode: StatusCodes.OK, success: true, message: "Posts retrieved successfully", meta: result.meta, data: result.data });
  } catch (error: any) {
    sendResponse(res, { statusCode: StatusCodes.BAD_REQUEST, success: false, message: error?.message, data: null });
  }
};
...
const createTip = async (req: Request, res: Response) => {
  try {
    ...
    sendResponse(res, { statusCode: StatusCodes.CREATED, success: true, message: "Tip submitted successfully", data: result });
  } catch (error: any) {
    sendResponse(res, { statusCode: StatusCodes.BAD_REQUEST, success: false, message: error?.message, data: null });
  }
};
...
const getTips = async (req: Request, res: Response) => {
  try {
    ...
    sendResponse(res, { statusCode: StatusCodes.OK, success: true, message: "Tips retrieved successfully", data: result });
  } catch (error: any) {
    sendResponse(res, { statusCode: StatusCodes.BAD_REQUEST, success: false, message: error?.message, data: null });
  }
};
...
const deletePost = async (req: Request, res: Response) => {
  try {
    ...
    sendResponse(res, { statusCode: StatusCodes.OK, success: true, message: "Post deleted successfully", data: null });
  } catch (error: any) {
    sendResponse(res, { statusCode: StatusCodes.BAD_REQUEST, success: false, message: error?.message, data: null });
  }
};
...
const deleteTip = async (req: Request, res: Response) => {
  try {
    ...
    sendResponse(res, { statusCode: StatusCodes.OK, success: true, message: "Tip deleted successfully", data: null });
  } catch (error: any) {
    sendResponse(res, { statusCode: StatusCodes.BAD_REQUEST, success: false, message: error?.message, data: null });
  }
};
...
const resolvePost = async (req: Request, res: Response) => {
  try {
    ...
    sendResponse(res, { statusCode: StatusCodes.OK, success: true, message: "Post marked as resolved", data: result });
  } catch (error: any) {
    sendResponse(res, { statusCode: StatusCodes.BAD_REQUEST, success: false, message: error?.message, data: null });
  }
};
