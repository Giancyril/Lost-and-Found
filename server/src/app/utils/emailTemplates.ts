...
export const foundItemReportedTemplate = (data: {
  reporterName: string;
  itemName: string;
  location: string;
  date: string;
...
export const reminderEmailTemplate = (data: {
...
export const weeklyDeletionReportTemplate = (data: {
  pendingItems: Array<{
    type: string;
    name: string;
...
export const sheetsReconciliationAlertTemplate = (data: {
