...
import { FaPaperPlane, FaUserCircle, FaInbox, FaCircle, FaArrowLeft, FaComments, FaTimes } from "react-icons/fa";
...
const ChatDropdown = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {open && (
        <div className="absolute right-0 top-11 w-[320px] sm:w-[380px] bg-gray-900 border border-white/10 rounded-2xl shadow-2xl z-50 overflow-hidden flex flex-col h-[500px]">
          {/* Header */}
