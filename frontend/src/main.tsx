...
import StudentPointsHistory from "./dashboard/student-pages/StudentPointsHistory.tsx";
...
const router = createBrowserRouter([
  ...
  { path: "/dashboard/virtue-spotlight", element: <DashboardLayout><VirtueSpotlightAdmin /></DashboardLayout> },
  ...
  { path: "/dashboard/flagged-users", element: <DashboardLayout><FlaggedUsersManagement /></DashboardLayout> },
