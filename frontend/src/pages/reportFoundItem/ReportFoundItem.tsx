          ...
          <div className="bg-gray-900 rounded-2xl shadow-2xl border border-gray-800 p-8">
            ...
            <div className="mb-8 text-center">
              ...
              <p className="text-gray-500 text-sm">
                Fill out the details below to report an item you found on campus. Be as specific as possible to help the owner identify it.
              </p>
            </div>
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-sm"
                    placeholder="e.g. Contact me or visit the admin office"
                    {...register("claimProcess", {
                      required: "Claim instructions are required",
                    })}
                  />
                  {errors.claimProcess && (
                    <p className="text-red-400 text-xs mt-1">
