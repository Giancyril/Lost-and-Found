...
const SingleFoundItem = () => {
  ...
  const handleClaimModal = () => setIsClaimModalOpen(true);
          ...
          <div className="w-full px-6 sm:px-10 lg:px-16 py-5">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-500 text-sm mt-1">Found item details and claim information</p>
              </div>
            ...
            <div className="space-y-5">
              ...
              <div className="bg-gray-900 rounded-xl p-5 border border-gray-800">
                ...
                <p className="text-gray-400 leading-relaxed text-sm">
                  {foundItemData?.description || "No description available for this item."}
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-gray-900 rounded-xl p-4 border border-gray-800">
                  <div className="flex items-center gap-2 text-blue-400 mb-2">
                    <FaUser size={12} />
                    <span className="text-xs font-bold uppercase tracking-widest">Found By</span>
                  </div>
                  <p className="text-gray-300 text-sm">{foundItemData?.user?.username || "Anonymous"}</p>
                </div>
              </div>

              {/* Claim */}
              <div className="bg-gray-900 rounded-xl p-5 border border-gray-800">
                <h3 className="text-xs font-bold text-white uppercase tracking-widest mb-2">Claim Process</h3>
                <p className="text-gray-500 text-sm mb-4 leading-relaxed">
                  {foundItemData?.claimProcess || "To claim this item, provide the date you lost it and any distinguishing features to verify ownership."}
                </p>
                {!foundItemData?.isClaimed ? (
                  <button
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-sm">
          <div className="relative w-full max-w-md bg-gray-900 rounded-2xl border border-gray-800 shadow-2xl">
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-800">
              <div>
                <h3 className="text-base font-bold text-white">Claim This Item</h3>
                <p className="text-gray-500 text-xs mt-0.5">Verify your ownership to proceed</p>
              </div>
            ...
            <div className="px-6 py-5">
              <p className="text-gray-400 text-sm mb-6 leading-relaxed">
                To verify ownership, please provide the date you lost this item and any details that identify it as yours.
              </p>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                <div>
                  ...
                  <input
                    type="date"
                    {...register("lostDate", { required: "Please provide the date you lost this item" })}
                ...
                <div>
                  ...
                  <textarea
                    rows={4}
                    placeholder="e.g. Has a sticker on the back, initials written inside, specific color combination, serial number, etc."
