...
- **Gratitude & Community Rewards**: Digital thank-you notes and gratitude badges that display on hero student profiles to foster mutual respect and high-trust peer culture.
  - **Dynamic Thank-You Notes**: When a claim is completed and approved, owners can send custom, heart-warming digital notes directly from the chat screen.
  - **Premium Badges**: Choose from four unique, beautiful glassmorphic badges (*Heart of Gold*, *Superstar Finder*, *Community Hero*, *Kindness Envoy*) to showcase the finder's specific contribution.
  - **Profile Badge Showcase**: A gorgeous showcase widget on the Student Dashboard that displays active gratitude notes and counts for each award badge.
  - **XP & Points Economy Integration**: Sending a thank-you note automatically awards **50 Community Points** to the hero finder, directly increasing their student leaderboard rank.
